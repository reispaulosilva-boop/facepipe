...
export function Toolbox(props: ToolboxProps) {
  ...
  return (
    <>
            ...
            <ToolButton
              icon={
                <div className="relative flex items-center justify-center w-4 h-4">
                  ...
                  {(showThirds || showFifths || showBitemporal || showBizygomatic || showBigonial || showMentonian || showFacialShape) && (
                    <span className="absolute -top-0.5 -right-0.5 w-1.5 h-1.5 rounded-full bg-red-400 ring-1 ring-black/50" />
                  )}
                </div>
              }
              label="Medidas Faciais"
              active={showDistancesSubmenu || showThirds || showFifths || showBitemporal || showBizygomatic || showBigonial || showMentonian || showFacialShape}
      ...
      <FloatingPanel anchorRef={distancesRef} open={showDistancesSubmenu} title="Medidas Faciais" accentColor="amber">
        <div className="flex flex-col gap-0.5 p-2">
          {[
            { id: "thirds",      label: "Terços Faciais",  active: showThirds,      toggle: toggleThirds },
            { id: "fifths",      label: "Quintos Faciais",  active: showFifths,      toggle: toggleFifths },
            ...
            <button
              ...
              className={cn(
                ...
                showFacialShape
                  ...
                  : "text-white/40 border-transparent hover:bg-white/6 hover:text-white/80"
              )}
            >
